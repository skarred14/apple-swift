  ...
  foreach(arch ${architectures})
    if("${prefix}" STREQUAL "ANDROID")
      ...
      elseif("${prefix}" STREQUAL "MUSL")
        if(arch MATCHES "(armv6|armv7)")
          set(SWIFT_SDK_MUSL_ARCH_${arch}_TRIPLE "${arch}-unknown-musl-gnueabihf")
        elseif(arch MATCHES "(aarch64|i686|powerpc64|powerpc64le|s390x|x86_64)")
      ...
      elseif("${prefix}" STREQUAL "WASI")
        ...
        set(SWIFT_SDK_WASI_ARCH_wasm32_PATH "${SWIFT_WASI_SDK_PATH}/share/wasi-sysroot" CACHE PATH "Path to WASI sysroot.")
        set(SWIFT_SDK_WASI_ARCH_wasm32_TRIPLE "wasm32-unknown-wasi" CACHE PATH "WASI host triple.")
        set(SWIFT_SDK_WASI_ARCH_wasm32_LIBC_INCLUDE_DIRECTORY "${SWIFT_WASI_SDK_PATH}/share/wasi-sysroot/include" CACHE PATH "WASI include path")
        set(SWIFT_SDK_WASI_ARCH_wasm32_LIBC_ARCHITECTURE_INCLUDE_DIRECTORY "${SWIFT_WASI_SDK_PATH}/share/wasi-sysroot/include" CACHE PATH "WASI architecture include path.")
      else()
...
macro(configure_sdk_windows name environment architectures)
  ...
  set(SWIFT_SDK_${prefix}_STATIC_LIBRARY_PREFIX "")
  set(SWIFT_SDK_${prefix}_STATIC_LIBRARY_SUFFIX ".lib")
  set(SWIFT_SDK_${prefix}_IMPORT_LIBRARY_PREFIX "lib")
  set(SWIFT_SDK_${prefix}_IMPORT_LIBRARY_SUFFIX ".dll.a")
